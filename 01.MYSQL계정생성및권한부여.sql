...
-- 스키마 생성 후 왼쪽 Navigator 창에서 새로고침 클릭하면 추가된 스키마 확인할 수 있다.

-- greenit 사용자에게 권한 부여하기
-- GRANT 권한종류 PRIVILEGES ON 스키마.객체
GRANT ALL PRIVILEGES ON testdb.* TO 'greenit'@'%';	-- testdb 스키마의 모든 객체 사용 권한 부여함
