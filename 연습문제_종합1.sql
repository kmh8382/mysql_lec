...
(
    ...
    cust_addr VARCHAR(50) NOT NULL                COMMENT '주소',
...
(
    ...
    cust_id    INT  NOT NULL                COMMENT '고객번호',
    book_id    INT  NOT NULL                COMMENT '책번호',
    ...
    CONSTRAINT fk_order_book FOREIGN KEY(book_id) REFERENCES tbl_book(book_id) ON DELETE CASCADE
) ENGINE=InnoDB COMMENT '고객';
...
INSERT INTO tbl_customer VALUES (null, '장미란', '대한민국', '222-2222-2222');
...
*/
INSERT INTO tbl_order VALUES (null, 1000, 1,  1, '20-07-01');
INSERT INTO tbl_order VALUES (null, 1000, 3,  2, '20-07-03');
INSERT INTO tbl_order VALUES (null, 1001, 5,  1, '20-07-03');
INSERT INTO tbl_order VALUES (null, 1002, 6,  2, '20-07-04');
INSERT INTO tbl_order VALUES (null, 1003, 7,  3, '20-07-05');
INSERT INTO tbl_order VALUES (null, 1000, 2,  5, '20-07-06');
INSERT INTO tbl_order VALUES (null, 1003, 8,  2, '20-07-06');
INSERT INTO tbl_order VALUES (null, 1002, 10, 2, '20-07-07');
INSERT INTO tbl_order VALUES (null, 1001, 10, 1, '20-07-08');
INSERT INTO tbl_order VALUES (null, 1002, 6,  4, '20-07-10');
...
-- 8        10     올림픽 챔피언
-- 9        10     올림픽 챔피언
SELECT order_id, o.book_id, b.book_id, book_name
FROM tbl_order o  INNER JOIN tbl_book b
ON o.book_id = b.book_id
WHERE ordered_at BETWEEN '20-07-05' AND '20-07-09';
